 ...
 * @ORM\Entity(repositoryClass="ProduitsBundle\Repository\UtilisateursAdressesRepository")
 */
class UtilisateursAdresses
{
     ...
     * Set utilisateur
     *
     * @param \User\UserBundle\Entity\User $utilisateur
     *
     * @return UtilisateursAdresses
     */
    public function setUtilisateur(\User\UserBundle\Entity\User $utilisateur = null)
    {
